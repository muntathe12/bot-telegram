...
💡 **نصيحة:** يمكنك إرسال أي رابط فيديو وسأحاول تحميله!
    ...
    async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # معالجة كل رابط
        for url in urls:
            await self.process_video_url(update, url)
    
    async def process_video_url(self, update: Update, url: str):
        """
        ...
        try:
            ...
            with open(video_info['file_path'], 'rb') as video_file:
                caption = self.create_video_caption(video_info, url)
    ...
    def create_video_caption(self, video_info: dict, url: str) -> str:
        """
        إنشاء وصف للفيديو
        """
